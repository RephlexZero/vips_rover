...
echo "  ./scripts/sim      - Start simulation in Gazebo"
echo "  ./scripts/real     - Start real rover hardware"
echo "  ./scripts/nav_sim  - Start autonomous navigation in simulation"
echo "  ./scripts/nav_hw   - Start autonomous navigation on hardware"
